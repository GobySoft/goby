...
{
  public:
    LiaisonCommander(ZeroMQService* zeromq_service, const protobuf::LiaisonConfig& cfg,
  ...
  private:
    ...
    {
        ControlsContainer(MOOSNode* moos_node,
                          const protobuf::ProtobufCommanderConfig& pb_commander_config,
                          Wt::WStackedWidget* commands_div, Wt::WContainerWidget* parent = 0);
        ...
        {
            CommandContainer(MOOSNode* moos_node,
                             const protobuf::ProtobufCommanderConfig& pb_commander_config,
