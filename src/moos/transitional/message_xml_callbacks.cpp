    ...
    const Attributes& attrs)      // elements's attributes
{
    ...
    switch (current_tag)
    {
        ...
        case tag_layout: break;

        case tag_publish: messages.back().add_publish(); break;
        ...
        case tag_repeat: messages.back().set_repeat_enabled(true); break;

        case tag_all: messages.back().last_publish().set_use_all_names(true); break;
    ...
    const XMLCh* const qname)     // tagname + NS pefix
{
    ...
    switch (current_tag)
    {
        ...
        case tag_max_delta: messages.back().last_message_var().set_max_delta(trimmed_data); break;

        case tag_format: messages.back().last_publish().set_format(trimmed_data); break;

        case tag_id: messages.back().set_id(trimmed_data); break;

        case tag_incoming_hex_moos_var: messages.back().set_in_var(trimmed_data); break;

        case tag_max_length: messages.back().last_message_var().set_max_length(trimmed_data); break;

        case tag_num_bytes: messages.back().last_message_var().set_num_bytes(trimmed_data); break;

        case tag_max: messages.back().last_message_var().set_max(trimmed_data); break;

        case tag_message_var: messages.back().last_publish().add_name(trimmed_data); break;

        case tag_min: messages.back().last_message_var().set_min(trimmed_data); break;
        ...
        case tag_outgoing_hex_moos_var: messages.back().set_out_var(trimmed_data); break;

        case tag_precision: messages.back().last_message_var().set_precision(trimmed_data); break;

        case tag_size: messages.back().set_size(trimmed_data); break;

        case tag_trigger_var: messages.back().set_trigger_var(trimmed_data); break;

        case tag_trigger_time: messages.back().set_trigger_time(trimmed_data); break;

        case tag_trigger: messages.back().set_trigger(trimmed_data); break;
