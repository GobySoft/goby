...
void handle_encode_on_demand(const goby::acomms::protobuf::ModemDataRequest& request_msg, boost::shared_ptr<google::protobuf::Message> data_msg);
...
{    
    ...
    std::cout << "data message: " << data_msg << std::endl;
    std::cout << "received data (as hex): " << goby::util::hex_encode(data_msg.data()) << std::endl; 
