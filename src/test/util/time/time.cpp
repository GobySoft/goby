...
uint64 fake_time() { return TEST_MICROSEC_TIME; }
...
int main()
{
    ...
    std::cout << "as<string>(as<uint64>(ptime): "
              << goby::util::as<std::string>(goby::util::as<uint64>(TEST_PTIME)) << std::endl;
    ...
    assert(as<ptime>(goby_time<uint64>()) - boost::posix_time::microsec_clock::universal_time() <
           boost::posix_time::milliseconds(10));
