    ...
    {    
        ...
        class DCCLMessageVarTime : public DCCLMessageVarHead
        {
          ...
          DCCLMessageVarTime():
            ...
            void write_schema_to_dccl2(std::ofstream* proto_file,
                                               int sequence_number)
            {
                *proto_file << "\t" << "optional string " << name() << " = " << sequence_number << " [(dccl_field).codec=\"_time\", (dccl_field).in_head=true, (queue_field).is_time=true];" << std::endl;
            }
        ...
        class DCCLMessageVarSrc : public DCCLMessageVarHead
        {
          ...
          DCCLMessageVarSrc()
            ...
            { return "(dccl_field).in_head=true, (queue_field).is_src=true"; }
        ...
        class DCCLMessageVarDest : public DCCLMessageVarHead
        {
          ...
          DCCLMessageVarDest():
            ...
            virtual std::string additional_option_extensions()
            { return "(dccl_field).in_head=true, (queue_field).is_dest=true"; }
