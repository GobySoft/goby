...
// 
// this is message.h, part of libdccl
//
...
// the Message itself
    class Message 
    {
      public:
        ...
        void set_q_ack(const std::string& s) { set_q_ack(acomms_util::stricmp(s,"true")); }
        ...
        void set_q_newest_first(const std::string& s) { set_q_newest_first(acomms_util::stricmp(s,"true")); }
