...
\boxedverbatiminput{"../../cfg/examples/ex2_gps_driver/launch_list.txt"}
\resetbvlinenumber
...
\end{boxedverbatim}
\resetbvlinenumber
and enjoy the magic unfold. Should you wish to modify how things are launched, just edit launch\_list.txt in goby/cfg/examples/ex2\_gps\_driver.
...
This entire example can be browsed online at \url{http://bazaar.launchpad.net/~goby-dev/goby/1.0/files/head:/src/core/examples/ex2_gps_driver}.

\subsection{goby/src/core/examples/ex2\_gps\_driver/config.proto} \label{sec:gps_driver:config.proto}
\boxedverbatiminput{"../../src/core/examples/ex2_gps_driver/config.proto"}
\resetbvlinenumber

\subsection{goby/src/core/examples/ex2\_gps\_driver/depth\_reading.proto} \label{sec:gps_driver:depth_reading.proto}
\boxedverbatiminput{"../../src/core/examples/ex2_gps_driver/depth_reading.proto"}
\resetbvlinenumber

\subsection{goby/src/core/examples/ex2\_gps\_driver/depth\_simulator.cpp} \label{sec:gps_driver:depth_simulator.cpp}
\boxedverbatiminput{"../../src/core/examples/ex2_gps_driver/depth_simulator.cpp"}
\resetbvlinenumber

\subsection{goby/src/core/examples/ex2\_gps\_driver/node\_report.proto} \label{sec:gps_driver:node_report.proto}
\boxedverbatiminput{"../../src/core/examples/ex2_gps_driver/node_report.proto"}
\resetbvlinenumber


\subsection{goby/src/core/examples/ex2\_gps\_driver/node\_reporter.h} \label{sec:gps_driver:node_reporter.h}
\boxedverbatiminput{"../../src/core/examples/ex2_gps_driver/node_reporter.h"}
\resetbvlinenumber


\subsection{goby/src/core/examples/ex2\_gps\_driver/node\_reporter.cpp} \label{sec:gps_driver:node_reporter.cpp}
\boxedverbatiminput{"../../src/core/examples/ex2_gps_driver/node_reporter.cpp"}
\resetbvlinenumber


\subsection{goby/src/core/examples/ex2\_gps\_driver/gps\_nmea.proto} \label{sec:gps_driver:gps_nmea.proto}
\boxedverbatiminput{"../../src/core/examples/ex2_gps_driver/gps_nmea.proto"}
\resetbvlinenumber

\subsection{goby/src/core/examples/ex2\_gps\_driver/gps\_driver.h} \label{sec:gps_driver:gps_driver.h}
\boxedverbatiminput{"../../src/core/examples/ex2_gps_driver/gps_driver.h"}
\resetbvlinenumber
\subsection{goby/src/core/examples/ex2\_gps\_driver/gps\_driver.cpp} \label{sec:gps_driver:gps_driver.cpp}
\boxedverbatiminput{"../../src/core/examples/ex2_gps_driver/gps_driver.cpp"}
\resetbvlinenumber

\subsection{goby/cfg/examples/ex2\_gps\_driver/gobyd.cfg} \label{sec:gps_driver:gobyd.cfg}
\boxedverbatiminput{"../../cfg/examples/ex2_gps_driver/gobyd.cfg"}
\resetbvlinenumber

\subsection{goby/cfg/examples/ex2\_gps\_driver/depth\_simulator\_g.cfg} \label{sec:gps_driver:depth_simulator_g.cfg}
\boxedverbatiminput{"../../cfg/examples/ex2_gps_driver/depth_simulator_g.cfg"}
\resetbvlinenumber

\subsection{goby/cfg/examples/ex2\_gps\_driver/gps\_driver\_g.cfg} \label{sec:gps_driver:gps_driver_g.cfg}
\boxedverbatiminput{"../../cfg/examples/ex2_gps_driver/gps_driver_g.cfg"}
\resetbvlinenumber

\subsection{goby/cfg/examples/ex2\_gps\_driver/node\_reporter\_g.cfg} \label{sec:gps_driver:node_reporter_g.cfg}
\boxedverbatiminput{"../../cfg/examples/ex2_gps_driver/node_reporter_g.cfg"}
\resetbvlinenumber

\subsection{goby/cfg/examples/ex2\_gps\_driver/nmea.txt} \label{sec:gps_driver:nmea.txt}
\boxedverbatiminput{"../../cfg/examples/ex2_gps_driver/nmea.txt"}
\resetbvlinenumber
