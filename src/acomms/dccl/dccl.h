    ...
    namespace acomms
    {
        ...
        class DCCLCodec
        {
          public:
            ...
            ///
            /// \param encoded Pointer to byte string to store encoded msg
            ...
            ///
            /// \param msg Pointer to any Google Protobuf Message generated by protoc (i.e. subclass of google::protobuf::Message)
            ...
            void validate_repeated(const std::list<const google::protobuf::Descriptor*>& desc);
            ...
            /// \return pointer to decoded message (a google::protobuf::Message). You are responsible for deleting the memory used by this pointer.
            template<typename GoogleProtobufMessagePointer>
