...
void init_transmission(const goby::modem::Message&);
...
int main(int argc, char* argv[])
{
    ...
    //
    goby::amac::MACManager mac(&std::cout);
    ...
    //
    mac.set_type(goby::amac::mac_slotted_tdma);
    mac.set_rate(0);
    ...
    // give a callback to use for actually initiating the transmission. this would be bound to goby::modem::DriverBase::initiate_transmission if using libmodemdriver.
    ...
    mac.process_message(goby::modem::Message("src=2"));
    mac.process_message(goby::modem::Message("src=3"));
...
void init_transmission(const goby::modem::Message& init_message)
{
