...
SerialClient::SerialClient(asio::io_service& io_service,
...
void SerialClient::start(const std::string & name, unsigned int baud)
{
...
void SerialClient::read_start(void)
...
void SerialClient::read_complete(const asio::error_code& error, size_t bytes_transferred)
...
void SerialClient::do_write(const std::string & line) // give it a string
...
void SerialClient::write_complete(const asio::error_code& error)
{ // the asynchronous read operation has now completed or failed and returned an error
    if (!error)
...
void SerialClient::do_close(const asio::error_code& error)
