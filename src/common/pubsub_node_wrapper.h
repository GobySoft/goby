          ...
          private:
            ...
            void set_cfg(const protobuf::PubSubSocketConfig& cfg)
            {
                ...
                if(using_pubsub())
                {
                    ...
                    glog.is(goby::util::logger::DEBUG1) && glog << "Subscriber socket: " << subscriber_socket->DebugString() << std::endl;
                    ...
                    glog.is(goby::util::logger::DEBUG1) && glog << "Publisher socket: " << publisher_socket->DebugString() << std::endl;

                }
                else
                {
                    glog.is(goby::util::logger::DEBUG1) && glog << "Not using publish / subscribe. Set publish_socket and subscribe_socket to enable publish / subscribe." << std::endl;
                }
